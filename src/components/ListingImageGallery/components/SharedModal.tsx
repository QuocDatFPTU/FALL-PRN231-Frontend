...
import { ListingGalleryImage } from "../utils/type";
  ...
  export default function SharedModal({
    ...
    return (
      ...
      >
        <div
          className="ccccccccccccccc relative z-50 flex aspect-[3/2] w-full max-w-7xl items-center wide:h-full xl:taller-than-854:h-auto"
          {...handlers}
        >
          {/* Main image */}
